...
<div>
  <data-aos data-aos="fade-down" data-aos-delay={(index)*200} data-aos-duration="500">
    <a class="block cursor-pointer min-h-[350px] md:min-h-[450px] w-full bg-secondary-blue rounded-md relative solution"  on:click|preventDefault={()=>openModal()} data-aos="fade-down" data-aos-duration="700">
