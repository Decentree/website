...
export default defineConfig({
  ...
  shortcuts: {
    'main-input': 'block w-full py-3 px-4 text-base md:text-lg rounded-md bg-secondary-blue border-2 border-primary-green text-white border-solid placeholder:text-gray-400 focus:outline-secondary-green',
